...
The evaluator was integrated into Mizar `main` at [787e9b6](https://github.com/levarac/mizar/commit/787e9b6a27d1f9645b5d7a7997c137b027f5ac86), from `feat/evaluator` revision `a7a94a3`. Revision targets and command descriptions inside the prompts remain historical. Use the [current evaluator documentation](https://github.com/levarac/mizar/blob/bf91f6658980019d502993f6e33720cd39f11006/evaluator/README.md) for live evaluation and verification, including environment-based RPC input, externally obtained trusted parameters, and credential-source and log-range options. Its live evaluation path is tested against a JSON-RPC stub, and a live read-only evaluation rehearsal ran against Sepolia on 2026-09-26; see the [submission README](../../README.md#evaluator-live-read-only-rehearsal). No snapshot root has been posted. The evaluator-backed E2E runner reviewed here at `c9c7f1d` was later integrated into `main` at `2530658`.
