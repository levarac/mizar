...
| 3:15–3:30 | End card: public Mizar and Alcor repository names, deployed contract and Alcor status, pending claim page/video, MIT and brief AI disclosure. | “The claim contract is deployed on Sepolia, and Alcor is deployed in World ID staging. The claim page is pending; a live World proof and app callback remain unverified. The code is MIT licensed, with development directed and reviewed by the team.” |
