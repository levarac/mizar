...
| 3:15–3:30 | End card: public Mizar and Alcor repository names, MIT, pending live deployment/video status, brief AI disclosure. | “The Sepolia deployment of the claim contract and the live configuration are still pending in this snapshot. The code is MIT licensed. The team directed and reviewed AI-assisted development, with each branch reviewed by a separate AI agent before integration. Mizar's contribution is a reproducible interpretation of shared evidence.” |
