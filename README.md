...
The app-side typed signing entry point is new hackathon work inside [Beid](https://github.com/levarac/beid). Beid's repository is public, but this README's local checks do not independently verify the app-side integration.
